...
**Verification depth scales with `asvs_level`** (see @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
