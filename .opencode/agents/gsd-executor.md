...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/ios-scaffold.md
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/summary.md
