...
<required_reading>
Read `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
