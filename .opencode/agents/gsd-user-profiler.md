...
<reference>
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/user-profiling.md` to load:
