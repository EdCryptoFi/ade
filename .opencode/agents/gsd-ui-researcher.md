...
Use template from `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/UI-SPEC.md`
