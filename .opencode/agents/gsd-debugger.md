...
<required_reading>
@.opencode/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@.opencode/gsd-core/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = .opencode/gsd-core
                  → writes to .opencode/gsd-core/hooks/
...
@.opencode/gsd-core/references/debugger-bug-taxonomy.md
...
@.opencode/gsd-core/references/debugger-repro-hardening.md
...
@.opencode/gsd-core/references/debugger-semantic-recall.md
...
@.opencode/gsd-core/references/thinking-models-debug.md
...
@.opencode/gsd-core/references/debugger-sbfl.md
...
- Read @.opencode/gsd-core/references/common-bug-patterns.md
...
@.opencode/gsd-core/references/debugger-rca-branching.md
...
@.opencode/gsd-core/references/debugger-fix-acceptance.md
...
@.opencode/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@.opencode/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
