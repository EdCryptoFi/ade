...
<required_reading>
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode
                  → checks /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core
                  → writes to /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/hooks/
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-bug-taxonomy.md
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-repro-hardening.md
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-semantic-recall.md
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/thinking-models-debug.md
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-sbfl.md
...
- Read @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/common-bug-patterns.md
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-rca-branching.md
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-fix-acceptance.md
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
