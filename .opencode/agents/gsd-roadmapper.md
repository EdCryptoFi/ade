...
Reference full template: `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/state.md`.
