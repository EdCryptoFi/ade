...
<!-- For checkpoint task examples and patterns, see @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/checkpoints.md -->
...
See `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/workflows/verify-phase.md` for verification logic.
