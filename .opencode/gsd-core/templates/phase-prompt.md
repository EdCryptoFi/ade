...
<!-- For checkpoint task examples and patterns, see @.opencode/gsd-core/references/checkpoints.md -->
...
See `.opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `.opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `.opencode/gsd-core/workflows/verify-phase.md` for verification logic.
