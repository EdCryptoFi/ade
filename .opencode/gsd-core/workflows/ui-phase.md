...
Template: .opencode/gsd-core/templates/UI-SPEC.md
</output>
...
@.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / .opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  ".opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  ".opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
