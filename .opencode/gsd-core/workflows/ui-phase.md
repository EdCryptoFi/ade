...
```markdown
Read /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/agents/gsd-ui-checker.md for instructions.
...
@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
