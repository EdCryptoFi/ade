...
```markdown
Read /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/agents/gsd-eval-planner.md for instructions.
