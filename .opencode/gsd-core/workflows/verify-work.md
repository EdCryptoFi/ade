...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@.opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `.opencode/gsd-core/workflows/transition.md`.
...
- Follow @.opencode/gsd-core/workflows/diagnose-issues.md
