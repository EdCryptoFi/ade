...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/workflows/transition.md`.
...
- Follow @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/workflows/diagnose-issues.md
