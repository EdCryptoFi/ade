...
ones). Reference: @.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / .opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  ".opencode/gsd-core/bin/lib/edge-probe.cjs" \
  ".opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @.opencode/gsd-core/templates/spec.md.
