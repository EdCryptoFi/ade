...
ones). Reference: @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/spec.md.
