...
See /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/discovery.md
...
Use /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/discovery.md.
