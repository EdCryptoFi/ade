...
Key references:
- @.opencode/gsd-core/references/ui-brand.md (display patterns)
- @.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @.opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH=".opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp ".opencode/gsd-core/USER-PROFILE.md" ".opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at .opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `.opencode/gsd-core/references/user-profiling.md`
...
Reference: @.opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to .opencode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to .opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at .opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at .opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to .opencode/AGENTS.md"
...
```bash
BACKUP_PATH=".opencode/USER-PROFILE.backup.md"
```
...
Your profile:    .opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   .opencode/skills/gsd-dev-preferences/SKILL.md
