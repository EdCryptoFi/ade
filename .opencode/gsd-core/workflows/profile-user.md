...
Key references:
- @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/ui-brand.md (display patterns)
- @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/USER-PROFILE.md" "/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/user-profiling.md`
...
Reference: @/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.opencode/AGENTS.md>
  ✓ Global AGENTS.md        /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/AGENTS.md
```
