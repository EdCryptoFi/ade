...
```
Agent(
  prompt="Read /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/templates/VALIDATION.md`
