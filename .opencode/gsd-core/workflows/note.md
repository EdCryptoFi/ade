...
- **Global scope**: `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/notes/`)
...
2. Glob `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/notes/` — works in any directory
