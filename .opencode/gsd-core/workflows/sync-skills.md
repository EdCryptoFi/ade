...
INSTALL_JS_GLOBAL="/Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Volumes/VibeCode/Architeture Decision Engine/ade/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
