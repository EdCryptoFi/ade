  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-16 md:py-24">
        ...
        <section className="border-t border-zinc-800 py-20"><div className="mb-10 max-w-xl space-y-3"><p className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-500">Three ways to use ADE</p><h2 className="text-3xl font-bold tracking-tight">Buy the decision you need.</h2></div><div className="grid gap-3 md:grid-cols-3"><div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6"><p className="text-sm font-semibold">Architecture Analysis</p><p className="mt-3 text-2xl font-bold">$0.50</p><p className="mt-3 text-sm leading-6 text-zinc-500">Architecture, stack, data model, infrastructure, components, and implementation plan.</p></div><div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6"><p className="text-sm font-semibold">Security Audit</p><p className="mt-3 text-2xl font-bold">$1.00</p><p className="mt-3 text-sm leading-6 text-zinc-500">Prioritized risks, severity, evidence, mitigations, and suggested tests.</p></div><div className="rounded-2xl border border-emerald-800 bg-emerald-950/20 p-6"><p className="text-sm font-semibold text-emerald-300">Architecture + Security Blueprint</p><p className="mt-3 text-2xl font-bold">$5.00</p><p className="mt-3 text-sm leading-6 text-zinc-400">The complete architecture and security package for an AI-assisted build.</p></div></div></section>
      </main>
